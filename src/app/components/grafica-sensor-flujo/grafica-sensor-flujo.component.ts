...
@Component({
  selector: 'app-grafica-sensor-flujo',
  templateUrl: './grafica-sensor-flujo.component.html',
  styleUrls: ['./grafica-sensor-flujo.component.css']
})
export class GraficaSensorFlujoComponent {
